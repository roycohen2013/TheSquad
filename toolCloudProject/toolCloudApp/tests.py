...
class notificationTests (TestCase):
    ...
    def setUp (self):
        ...
        #genNotif = newNotification = Notification(source = genShed)
       # genNotif = notifUtils.createNotificationInfo(genShed)
        #self.assertEqual (profUtils.getPhoneNumber (getProfile), "1111111111")

        #getNotif = Notification.objects.get (name = "shed notification test") #make sure the shed was actually saved to the db
