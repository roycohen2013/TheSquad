...
"""
def getRequestNotifOfAction(actionObj):
	for notif in actionObj.sourceActionNotification.all():
	    if notif.notificationType == "request":
	    	return notif

def getInfoNotifOfAction(actionObj):
	for notif in actionObj.sourceActionNotification.all():
